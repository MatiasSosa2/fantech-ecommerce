      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="#" className="text-white hover:text-cyan transition">Preguntas frecuentes</Link></li>
              <li><Link href="#" className="text-white hover:text-cyan transition">Envíos</Link></li>
              <li><Link href="#" className="text-white hover:text-cyan transition">Garantía</Link></li>
              <li><a href="https://wa.me/" target="_blank" rel="noreferrer" className="text-white hover:text-cyan transition">Contacto por WhatsApp</a></li>
            </ul>
          </div>
          <div>
            <div className="text-sm font-semibold text-white/90">Legal</div>
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="#" className="text-white hover:text-cyan transition">Política de privacidad</Link></li>
              <li><Link href="#" className="text-white hover:text-cyan transition">Términos</Link></li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><a href="https://wa.me/" target="_blank" rel="noreferrer" className="text-white hover:text-cyan transition">WhatsApp</a></li>
